...
First, connect to the database. The package is using the CDMConnector object. You can create this object by passing a DBI connection and schema names. When creating a DBIConnection using dbConnect, please don't forget to specify the bigint parameter (see below). If this is not set, you could get a merge error when running DrugExposureDiagnostics. 
More examples of how to connect your database using CDMConnector can be found here: 
