...
First setup a database connection. The package is using the CDMConnector object. You can create this object by passing a DBI connection and schema names. When creating a DBIConnection using dbConnect, please don't forget to specify the bigint parameter (see below). If this is not set, you could get a merge error when running DrugExposureDiagnostics. 
In this case we will be using the mock that is provided by the package.
```{r}
#' conn <- DBI::dbConnect(
#'  RPostgres::Postgres(),
#'  dbname = dbname,
