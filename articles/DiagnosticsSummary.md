...
The diagnosticsSummary summarises the diagnostics results from the
package. For a complete diagnostics Summary the checks “missing”,
“exposureDuration”, “type”, “route”, “dose” and “quantity” are needed.
They make up the individual components of the diagnostic Summary. If
fewer checks are run, the diagnostics Summary will contain fewer
components.
