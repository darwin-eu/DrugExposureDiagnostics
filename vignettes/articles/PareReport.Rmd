---
title: "PaRe Report: DrugExposureDiagnostics [0.4.6]"
...
output:
  html_document:
    ...
    theme: cosmo
vignette: >
  %\VignetteIndexEntry{DrugExposureDiagnostics [0.4.6]}
...
tempDir <- tempdir()
pathToRepo <- file.path(tempDir, "DrugExposureDiagnostics")
git2r::clone(
  url = "https://github.com/darwin-eu/DrugExposureDiagnostics.git",
